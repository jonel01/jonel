...
import {
  MDBContainer, MDBRow, MDBCarousel, MDBCarouselInner, MDBCarouselItem,
} from 'mdbreact';
                    ...
                    isLoading ? ''
                      : (
                        <MDBContainer style={styles.cardContainer}>
                          <MDBCarousel activeItem={1} length={2} slide showControls showIndicators multiItem>
                            <MDBCarouselInner>
                              <MDBRow md="12">
