...
import {
  MDBContainer, MDBAnimation, MDBRow,
} from 'mdbreact';
        ...
        <MDBAnimation type="zoomIn" delay="0.5s">
          <MDBRow md="12">
            <MDBContainer style={styles.btnCounterContainer}>
              ...
              />
              <ul style={styles.ulList}>{storedResults.map((strResult) => (<li key={strResult.id} onClick={() => onDeleteResult(strResult.id)}>
                <Text
                  text={strResult.value}
                  color="white"
                />
              </li>))}
              </ul>
